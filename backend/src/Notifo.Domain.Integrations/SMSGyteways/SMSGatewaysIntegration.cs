...
public sealed partial class SMSGatewaysIntegration : IIntegration
{

    private readonly ISMSGatewaysRouter smsGatewaysRouter;
    private readonly XMLGateway xmlGateway;
    private readonly SMSCGateway smscGateway;
    private readonly IntelTeleGateway intelTeleGateway;
    ...
    {
        EditorLabel = "API key of Intel-Tele client",
        EditorDescription = null,
        IsRequired = false,
    };
    public static readonly IntegrationProperty EnabledIntelTeleProperty = new IntegrationProperty("EnabledIntelTele", PropertyType.Boolean)
    {
    ...
    public IntegrationDefinition Definition { get; } =
      new IntegrationDefinition(
          ...
          new List<IntegrationProperty>
          {
                ...
                EnabledXMLProperty,
                LoginSMSCProperty,
                PasswordSMSCProperty,
                EnabledSMSCProperty,
                LoginIntelTeleProperty,
                PasswordIntelTeleProperty,
                EnabledIntelTeleProperty,
          },
          new List<IntegrationProperty>(),
          new HashSet<string>
          {
      ...
      {
          Description = Texts.SMSGateway_description
      };

    public SMSGatewaysIntegration(ISMSGatewaysRouter smsGatewaysRouter,
                                    XMLGateway xmlGateway,
                                    SMSCGateway smscGateway,
                                    IntelTeleGateway intelTeleGateway)
    {
        this.smsGatewaysRouter = smsGatewaysRouter;
        this.xmlGateway = xmlGateway;
        this.smscGateway = smscGateway;
        this.intelTeleGateway = intelTeleGateway;
    }
}
